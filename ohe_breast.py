...
print(cancer_data.iloc[:,1:].describe().round(2))
...
new_cancer_data_1 = pd.get_dummies(new_cancer_data_1, columns=['diagnosis'])
#new_cancer_data_1['diagnosis_B'] = new_cancer_data_1['diagnosis_B'].astype(int)
#new_cancer_data_1['diagnosis_M'] = new_cancer_data_1['diagnosis_M'].astype(int)
print(new_cancer_data_1)


'''
# Create pairplots of all the numeric attributes stratified on diagnosis
cancer_pairplot = sns.pairplot(new_cancer_data_1.iloc[:,1:], hue='diagnosis_M')
...
for t, l in zip(cancer_pairplot._legend.texts, new_labels.values()):
    ...
    t.set_fontsize(12)
plt.show()
#plt.savefig("cancer_pairplot_onehot.png")

# Create and plot correlation matrix
correlation_matrix = new_cancer_data_1.iloc[:,1:].corr()
...
#plt.show()
plt.savefig("correlation_matrix_onehot.png")
...
X = new_cancer_data_1.drop(columns=['diagnosis_B', 'diagnosis_M']) 
y = new_cancer_data_1['diagnosis_M'] # The attribute we want to predict
...
plt.grid(True)
#plt.show()
plt.savefig("variance_explained_onehot.png")
...
plt.grid()
#plt.show()
plt.savefig("cumulative_variance_onehot.png")
...
plt.grid(True)
#plt.show()
plt.savefig("PCA_plot_onehot.png")
...
#plt.show()
plt.savefig("projections_first_three_onehot.png")
...
#plt.show()
plt.savefig("covariance_matrix_onehot.png")
'''
